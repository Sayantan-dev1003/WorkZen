...
const EmployeeSidebar = () => {
  ...
  return (
    <motion.aside
      ...
      className="bg-gradient-to-b from-purple-600 via-violet-700 to-indigo-800 text-white min-h-screen flex flex-col fixed left-0 top-0 bottom-0 z-20 shadow-2xl overflow-hidden"
    >
      {/* Decorative Background Pattern */}
      <div className="absolute inset-0 opacity-10 pointer-events-none">
        <div className="absolute top-10 right-10 w-32 h-32 bg-white rounded-full blur-3xl"></div>
        <div className="absolute bottom-20 left-10 w-40 h-40 bg-violet-300 rounded-full blur-3xl"></div>
      ...
      >
        ...
        >
          <motion.div
            ...
            className="p-3 bg-gradient-to-br from-violet-400 to-indigo-300 rounded-xl flex items-center justify-center shadow-lg"
          >
                  ...
                  >
                    ...
                    {isActive && (
                      <motion.div
                        ...
                        className="absolute left-0 top-0 bottom-0 w-1 bg-gradient-to-b from-violet-300 to-indigo-200 rounded-r-full"
          ...
          >
            <div className="flex items-center justify-center gap-2 mb-2">
              <motion.div
                ...
                className="w-2 h-2 bg-violet-300 rounded-full shadow-lg shadow-violet-300/50"
              />
              <p className="text-xs text-violet-200 font-medium">
                System Active
              </p>
